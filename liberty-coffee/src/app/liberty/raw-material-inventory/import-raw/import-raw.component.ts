                ...
                .subscribe(
                  response => {
                    if (response) {
                      ...
                      Swal.fire('', 'ไม่สามารถเพิ่มข้อมูลนำเข้าวัตถุดิบได้', 'error');
                    }
                  },
                  error => {
                    // console.log(error)
        ...
        .subscribe(
          response => {
            if (response) {
              ...
              // console.log("Login Fail")
              Swal.fire('', 'ไม่สามารถแก้ไขข้อมูลนำเข้าวัตถุดิบได้', 'error');
            }
          },
          error => {
            // console.log(error)
      ...
      .subscribe(
        response => {
          if (response) {
            ...
            this.DeleteStockLine(this.Stock_ID);
            Swal.fire('ลบข้อมูลการนำเข้าวัตถุดิบเรียบร้อยแล้ว', '', 'success');
          } else {
            // console.log("Login Fail")
            Swal.fire('', 'ไม่สามารถลบข้อมูลการนำเข้าวัตถุดิบได้', 'error');
          }
        },
        error => {
          // console.log(error)
